    ...
    <div className="purchase-overlay">
          ...
          <div className="success-popup">
            ...
            <div className="success-box">
              ...
              <div className="token-rights">
                ...
                <p><CheckCircle size={16} className="checkcircle" /> Full streaming access</p>
                <p><CheckCircle size={16} className="checkcircle" /> Non-transferable token</p>
                <p><CheckCircle size={16} className="checkcircle" /> Linked permanently to your wallet</p>
                <p><CheckCircle size={16} className="checkcircle" /> Secured on Sui blockchain</p>
              </div>

            </div>

            <button className="close-success-btn" onClick={onClose}>Done</button>
          </div>
        </div>
      )}
      ...
      {!showSuccess && (
        <div className="purchase-popup">
          ...
          <div className="purchase-box">
            ...
            <div className="access-rights">
              ...
              <p><CheckCircle className="checkcircle" size={16}/> Bound to this wallet only</p>
              <p><CheckCircle className="checkcircle" size={16}/> Non-transferable access pass</p>
              <p><CheckCircle className="checkcircle" size={16}/> Secured on Sui blockchain</p>
            </div>
        ...
        <div className="failed-popup-container">
            ...
            <button className="close-failed-btn" onClick={onClose}>Close</button>
